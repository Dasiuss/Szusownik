# Wymagania aplikacji (PWA) — analiza i prezentacja
...
## 3. Ekran główny (aktywność / dzień)

- Przycisk **„Pobierz dane"** — na razie ładuje mockowe dane z pliku CSV.
- Po kliknięciu: PWA przetwarza CSV (wycina zjazdy) i pokazuje **bieżącą aktywność (dzień)**.
...
## 5. Przetwarzanie danych (wycinanie zjazdów)
...
## 7. Stack technologiczny (propozycja do potwierdzenia)
