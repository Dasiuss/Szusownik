...
| Ścieżka     | Zawartość |
|-------------|-----------|
| `docs/`     | Dokumentacja: koncepcja, wymagania PWA, wymagania ESP, Supabase |
...
- `docs/koncepcja.md` — wizja, zakres, szczegóły implementacyjne, architektura, BOM, otwarte punkty.
